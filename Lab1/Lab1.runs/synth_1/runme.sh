...
HD_PWD='C:/Masters in Electrical Engineering/Semester 1/DAD/Labs/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myLogicFunction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myLogicFunction.tcl
