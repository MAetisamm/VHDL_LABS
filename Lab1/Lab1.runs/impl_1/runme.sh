...
HD_PWD='C:/Masters in Electrical Engineering/Semester 1/DAD/Labs/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myLogicFunction.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myLogicFunction.tcl -notrace
